            ...
            {menuarr?.map((menu) => {
                ...
                return (
                    <li
                        ...
                        className={`${
                            !!submenu ? "has-submenu" : ""
                        } group relative pt-4 pb-4 cursor-pointer text-orange font-bold z-10 before:bg-nav-shape before:empty-content before:absolute before:w-23.5 before:h-11 before:z-n1 before:top-1/2 before:left-1/2 before:transform before:-translate-x-2/4 before:-translate-y-2/4 before:transition-all before:opacity-0 hover:before:opacity-100`}
                    >
                        <Link
